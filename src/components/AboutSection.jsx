    ...
    <section className="bg-black text-white">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-70 flex items-center justify-center">
          <div className="text-center max-w-4xl px-4">
            <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-snug">
              "I've learned that exceptional service stems from genuine understanding and care. 
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">From Boiler Room to Boardroom</h2>
            <p className="text-lg">
              Kirk's journey began in the hearts of homes - their mechanical rooms. As a young apprentice, 
              he realized he wasn't just providing services; he was delivering comfort, safety, and peace of mind. 
              This revelation became the foundation for Maxwell Plumb Mechanical Corp.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-1 md:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">The Heart of Maxwell Plumb: Our Journey</h2>
            ...
            <p className="text-lg mb-4">
              As we look to the future, we're focused on pushing the boundaries of home services. We are investing in innovative technologies,
