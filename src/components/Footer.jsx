      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/" alt="Link to homepage" className="alt-brand-color">Home</a>
            </li>
            <li>
              <a href="/#services" alt="Link to all services" className="alt-brand-color">Services</a>
            </li>
            <li>
              <a href="/contact" alt="Link for contact page" className="alt-brand-color">Contact</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex space-x-4">
            <li>
              <a href="https://x.com/maxwellplumb" alt="X social media page for Maxwell Plumb" target="_blank" rel="noopener noreferrer" className="alt-brand-color">
            ...
            <li>
              <a href="https://www.linkedin.com/company/maxwellplumb/" alt="LinkedIn social media page for Maxwell Plumb" target="_blank" rel="noopener noreferrer" className="alt-brand-color">
                <svg className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <li>
              <a href="https://www.facebook.com/maxwellplumbmechanical/" alt="Facebook social media page for Maxwell Plumb" target="_blank" rel="noopener noreferrer" className="alt-brand-color">
                <svg className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <li>
              <a href="https://www.instagram.com/maxwell_plumb_mechanical/" alt="Instagram social media page for Maxwell Plumb" target="_blank" rel="noopener noreferrer" className="alt-brand-color">
                <svg className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
