...
const ServiceCard = ({ image, title, description, onClick }) => {
    return (
        <div onClick={onClick} className="block h-full no-underline cursor-pointer"> {/* Changed to div with onClick */}
            <div className="relative p-2 h-full">
                <div className="relative rounded-lg shadow-md overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl aspect-[3/4] group h-full">
                    ...
                    <div className="absolute bottom-0 left-0 p-6 w-full transition-transform duration-300 ease-in-out group-hover:-translate-y-2 group">
                        <div className="max-w-[65%]">
                            <h3 className="text-2xl font-extrabold mb-2 text-white leading-tight uppercase tracking-wide group-hover:text-[#1E90FF]">{title}</h3>
